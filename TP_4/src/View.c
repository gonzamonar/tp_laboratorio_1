...
int view_mainMenu(int qPassengers){
	...
	printf(" |  10. EJECUTAR TESTS DE LINKEDLIST                                                                    |\n");
	printf(" |  11. FUNCIONES ADICIONALES DE LINKEDLIST                                                             |\n");
	printf(" |  12. SALIR                                                                                           |\n");
	printf(" |                                                                                                      |\n");
	printf(" |------------------------------------------------------------------------------------------------------|\n");
	printf(" +------------------------------------------------------------------------------------------------------+\n\n");
...
int view_linkedlistMenu(){
	system("cls");
	int selection = 0;
	printf("\n\n");
	printf(" +------------------------------------------------------------------------------------------------------+\n");
	printf(" |-------------------------------------  *** MENÚ LINKEDLIST ***  --------------------------------------|\n");
	printf(" |------------------------------------------------------------------------------------------------------|\n");
	printf(" |                                                                                                      |\n");
	printf(" |   1. CREAR / ACTUALIZAR UNA COPIA DE SEGURIDAD DE LA LISTA PRINCIPAL (LL_CLONE)                      |\n");
	printf(" |   2. RECORTAR LISTADO DE COPIA DE SEGURIDAD (LL_SUBLIST)                                             |\n");
	printf(" |   3. LISTAR COPIA DE SEGURIDAD                                                                       |\n");
	printf(" |   4. LIMPIAR LA COPIA DE SEGURIDAD (LL_CLEAR)                                                        |\n");
	printf(" |   5. REMOVER UN ELEMENTO DE LA COPIA DE SEGURIDAD (LL_POP)                                           |\n");
	printf(" |   6. COPIAR O SOBRE-ESCRIBIR UN ELEMENTO DESDE LA LISTA DE SEGURIDAD (LL_PUSH / LL_SET)              |\n");
	printf(" |   7. VERIFICAR QUE LOS ELEMENTOS DE LA COPIA ESTÉN EN LA LISTA PRINCIPAL (LL_CONTAINSALL)            |\n");
	printf(" |   8. VERIFICAR SI LA COPIA DE SEGURIDAD ESTÁ VACÍA                                                   |\n");
	printf(" |   9. SALIR AL MENÚ PRINCIPAL                                                                         |\n");
	printf(" |                                                                                                      |\n");
	printf(" |------------------------------------------------------------------------------------------------------|\n");
	printf(" +------------------------------------------------------------------------------------------------------+\n\n");
	fflush(stdin);
...
void view_SelectionMenu_Backup(void){
	printf("\n\n    ----------------------------------------  * OPCIONES *  ------------------------------------------\n");
	printf("    --------------------------------------------------------------------------------------------------\n");
	printf("    ¿Cómo desea recuperar el elemento a la lista principal?\n");
	printf("    1. Copiarlo a la lista.\n");
	printf("    2. Sobre-escribir pasajero existente.\n");
	printf("    --------------------------------------------------------------------------------------------------\n");
}
